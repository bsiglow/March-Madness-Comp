...
Tourney_base <- read.csv("https://www.dropbox.com/s/zhb810pe94bd8ik/Tourney_base_table?dl=1") #this is the same
load("Team_Season_Kaggle_2021")
load("Kaggle_Tourney_2021_64") #
Gamebeast <-  xgb.load("Kaggle1_xgmodel") # Use 2021XGMOdel
...
# Any issues it may be do to the names.
```
...
```{r :: Tourney function}
Tourn_sim <- function(Kaggle_Tourney_2021_64,Team_Season_Kaggle_2021,Gamebeast, names)
{
